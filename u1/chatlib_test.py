...
def main():
	...
	check_parse("           LOGIN|   9|aaaa|bbbb", ("LOGIN", "aaaa|bbbb"))
	check_parse("LOGIN           |9   |aaaa|bbbb", ("LOGIN", "aaaa|bbbb"))
	check_parse("LOGIN           |	 09|aaaa|bbbb", ("LOGIN", "aaaa|bbbb"))  # Success - ascii char 9
	check_parse("LOGIN           |0009|aaaa|bbbb", ("LOGIN", "aaaa|bbbb"))  # Success
	...
	check_parse("LOGIN           | 0109|aaaa|bbbb", (None, None))
